...
window.relics = [
    {
        ...
        provenance: 'Private Collection\nFamily inheritance through multiple generations\nDocumented ownership history',
        provenanceChinese: '私人收藏\n家族世代傳承\n有記錄的所有權歷史',
        ...
        literature: 'Compare a similar example in the Palace Museum, Beijing, illustrated in "Complete Collection of Treasures of the Palace Museum: Porcelain of the Song Dynasty (I)", Hong Kong, 1996, pl. 5. Similar Ru ware pieces have been sold at major auction houses for significant sums.',
        literatureChinese: '可比較北京故宮博物院的一件類似藏品，見《故宮博物院藏品大系：宋代陶瓷卷（一）》，香港，1996年，圖5。類似的汝窯瓷器曾在主要拍賣行以高價成交。',
    ...
    },
    {
        ...
        culturalSignificance: 'Xuande marked cloisonné pieces are among the rarest and most sought-after works of Chinese decorative arts. This example bears the imperial six-character mark. The lotus scrolls symbolize continuous good fortune and prosperity. Xuande period pieces have achieved exceptional prices at auction.',
        culturalSignificanceChinese: '帶有宣德款的景泰藍器物是中國裝飾藝術中最稀有和最受追捧的作品之一。此例帶有皇家六字款。蓮花卷草象徵著連綿不斷的好運和繁榮。宣德年間的器物曾在拍賣中創下 exceptional 價格。',
    },
    {
        id: 4,
        lotNumber: '004',
    ...
    },
    {
        ...
        culturalSignificance: 'The Jingtai period is renowned for its advancements in cloisonné enamel techniques. This casket exemplifies the luxurious and noble characteristics unique to cloisonné enamel, demonstrating the dedication to creating objects of both beauty and function. Jingtai period pieces have achieved exceptional prices at auction.',
        culturalSignificanceChinese: '景泰年間以其景泰藍琺瑯技術的進步而聞名。這件蓋盒體現了景泰藍琺瑯獨有的奢華和高貴特徵，展示了創造美觀實用器物的 dedication。景泰年間的器物曾在拍賣中創下 exceptional 價格。',
    },
    {
        id: 6,
        lotNumber: '006',
